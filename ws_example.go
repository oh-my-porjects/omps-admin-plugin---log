...
func (p *LogPlugin) sendFriendRequest(ctx context.Context, fromUserID, toUserID, note string) error {
	// 1. 写库（业务自己做）
...
func (p *LogPlugin) handleTypingNotice(w http.ResponseWriter, r *http.Request) {
...
func (p *LogPlugin) registerAuthIfLoginModule(ctx PluginContext) {
...
// ============================================================================
//
// 在你的 LogPlugin struct 里加这些字段，并在 Init 里赋值：
//
